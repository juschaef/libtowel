...
t_htab_node			*twl_htab_node_new(void *key, void *data, uint32_t hash, t_copy_key *copy_key_fn);
void				twl_htab_node_del(t_htab_node *htab_node, t_htab_node_del_data_fn *delfn);
