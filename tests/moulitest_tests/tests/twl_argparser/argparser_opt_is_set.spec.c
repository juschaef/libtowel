...
#define mt_test_arg_parse_result_is_set(test_name, input, tested_opt, expected_result) \
...
mt_test_arg_parse_result_is_set(01, "echo -n -m abc", "n", true);
mt_test_arg_parse_result_is_set(02, "echo -n -m abc", "m", true);
mt_test_arg_parse_result_is_set(03, "echo -n -m abc", "y", false);
mt_test_arg_parse_result_is_set(04, "echo -n -m abc", "z", false);
mt_test_arg_parse_result_is_set(05, "echo -n -m abc", "newline", true);
mt_test_arg_parse_result_is_set(06, "echo -n -m abc", "module", true);
mt_test_arg_parse_result_is_set(07, "echo -n -m abc", "not_exist", false);
mt_test_arg_parse_result_is_set(08, "echo --module", "m", true);
mt_test_arg_parse_result_is_set(09, "echo --module", "module", true);
