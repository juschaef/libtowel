...
{
	mt_assert(twl_str_is_pos_num("11") == true);
}
...
{
	mt_assert(twl_str_is_pos_num("") == false);
}

static void negative_nbr(t_test *test)
{
	mt_assert(twl_str_is_pos_num("-42") == false);
}
static void large_nbr(t_test *test)
{
	mt_assert(twl_str_is_pos_num("97944654545656456456456456456445645645645656456456456") == true);
}

void	suite_twl_str_is_pos_num(t_suite *suite)
{
