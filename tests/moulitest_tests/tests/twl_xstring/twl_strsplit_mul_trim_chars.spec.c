...
static void simple_trim(t_test *test)
{
	...
	segs = twl_strsplit_mul_trim_chars(" \t\n aaa ; \t bbb \n", ";", "\t\n ");
...
static void if_statement_for_42sh_ast(t_test *test)
{
	...
	segs = twl_strsplit_mul_trim_chars("if [ 2 -eq 2 ] ; then echo YES; else echo NO ; fi ; echo abc", ";", "\t\n ");
...
void	suite_twl_strsplit_mul_trim_chars(t_suite *suite)
{
